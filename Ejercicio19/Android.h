...
class Android
{
  ...
  public:
    ...
    void draw(visual_t visualization, int left_arm_rotation, int right_arm_rotation, int head_rotation);
   private:
    //Metodos privados auxiliares para dibujar en Android entero
    void draw_aux_object();
    void draw_body(int left_arm_rotation, int right_arm_rotation);
    void draw_head(int head_rotation);
    void draw_arm();
    void draw_leg();
    void draw_eyes();
    void draw_antenna();
    void draw_robot(int left_arm_rotation, int right_arm_rotation, int head_rotation);
